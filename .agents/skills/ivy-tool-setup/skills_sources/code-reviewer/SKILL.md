...
**Frontend:** React, Next.js, React Native, Flutter, Vue 3, Element Plus
**Backend:** Node.js, Express, GraphQL, REST APIs, Spring Boot, MyBatis-Plus
**Database:** PostgreSQL, Prisma, NeonDB, Supabase, MySQL, Redis, Elasticsearch
...
Project-specific Vue 3 / Element Plus / Pinia guidelines in `references/vue3_best_practices.md`:

- Composition API / `<script setup>` 规范
- Element Plus auto-import 约定
- Pinia Store 规范
- API 层规范
- 路由与权限
- 常见反模式
...
Design document review guide in `references/design_review_checklist.md`:
...
- Vue 3 Guide: `references/vue3_best_practices.md`
- Design Review: `references/design_review_checklist.md`
